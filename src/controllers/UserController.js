...
// Controllers
// Controllers are routes, plus functions. They receive data from web requests, process that data (eg. with validation and/or sanitization), pass the data along to some functionality, and then return any function results to the requester as a response.

// This means your ExpressJS routers should be in your "controllers" directory. That's pretty much it.

// Your controllers can and should import your models - so a User Controller would import a User Model and do things with that.
